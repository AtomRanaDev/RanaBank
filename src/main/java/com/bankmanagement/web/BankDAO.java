...
public class BankDAO {
    ...
    private static final String URL =
            "jdbc:mysql://crossover.proxy.rlwy.net:14457/railway?useSSL=false";
    ...
    public static double getBalanceByCard(String cardNumber) {
        double balance = 0;
        String query = "SELECT balance FROM signupthree WHERE card_number = ?";
    ...
    public static boolean updateBalance(String cardNumber, double newBalance) {
        ...
        String query = "UPDATE signupthree SET balance = ? WHERE card_number = ?";
